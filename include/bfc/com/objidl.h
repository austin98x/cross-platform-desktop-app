...
//	File name		：	objidl.h
//	Author 			：	Austin
//	Create Time		：	2016-2-24 10:41:25
...
MIDL_INTERFACE_("00000100-0000-0000-C000-000000000046", IEnumUnknown)
	: public IUnknown
{
public:
...
public:
	...
	virtual size_type STDMETHODCALLTYPE GetSize(
		/* [in] */ void __RPC_FAR *pv) = 0;
...
MIDL_INTERFACE_("7FD52380-4E07-101B-AE2D-08002B2EC713", IPersistStreamInit)
	: public IPersist
{
public:
	virtual HRESULT STDMETHODCALLTYPE IsDirty( void) = 0;
...
typedef /* [unique] */ IPersistStreamInit __RPC_FAR *LPPERSISTSTREAMINIT;
...
MIDL_INTERFACE_("0000010b-0000-0000-C000-000000000046", IPersistFile)
	: public IPersist
{
public:
	virtual HRESULT STDMETHODCALLTYPE IsDirty( void) = 0;
...
MIDL_INTERFACE_("0000010a-0000-0000-C000-000000000046", IPersistStorage)
	: public IPersist
{
public:
	virtual HRESULT STDMETHODCALLTYPE IsDirty( void) = 0;
