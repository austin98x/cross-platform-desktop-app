/***
*strnicmp.h - compare n chars of wide-character strings, ignoring case
*
*       
*
*Purpose:
*       defines strnicmp() - Compares at most n characters of two xchar
...
/***
*int strnicmp(first, last, count) - compares count xchar of strings,
*       ignore case
*
*Purpose:
