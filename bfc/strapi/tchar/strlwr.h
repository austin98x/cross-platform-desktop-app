/***
*strlwr.h - routine to map upper-case characters in a xchar string
*       to lower-case
*
*       
*
...
/***
*xchar *strlwr(string) - map upper-case characters in a string to lower-case
*
*Purpose:
*       strlwr converts upper-case characters in a null-terminated xchar
